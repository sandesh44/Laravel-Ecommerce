...
<div id="breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@foreach ($products as $item)
                {{$item->productName}}
            @endforeach</li>
        </ul>
    </div>
                ...
                <div class="aside">
                    <h3 class="aside-title">Top Rated Product</h3>
                                                            ...
                                                            <div class="product product-widget">
                                                                ...
                                                                <h2 class="product-name"><a href="http://encoderslab.com/iPasal/theme8/product/best-desktop-entertainment-set">{{$item->name}}</a></h2>
